...
describe('music replay deterministic fixtures', () => {
  test('replays exact 4/4 timeline projection across arrangement and harmony changes', () => {
    ...
    expect(projection).toEqual([
      ...
      '24:build:1:8:1:1.20',
      '25:build:1:9:0:0.69',
      '26:build:1:10:0:0.69',
      '27:build:1:11:0:0.69',
      '28:build:1:12:0:1.20',
      '29:build:1:13:0:0.69',
      '30:build:1:14:0:0.69',
      '31:build:1:15:0:0.69',
    ]);
  });
  ...
  test('replays exact 7/8 timeline projection with odd-meter boundaries', () => {
    ...
    expect(projection).toEqual([
      ...
      '22:build:1:8:0:1.17',
      '23:build:1:9:1:0.77',
      '24:build:1:10:0:0.77',
      '25:build:1:11:0:1.17',
      '26:build:1:12:0:0.77',
      '27:build:1:13:0:0.77',
      '28:release:2:0:1:0.55',
      '29:release:2:1:0:0.84',
      '30:release:2:2:0:0.55',
      '31:release:2:3:1:0.55',
      '32:release:2:4:0:0.84',
      '33:release:2:5:0:0.55',
      '34:release:2:6:1:0.55',
      '35:release:2:7:0:0.55',
      '36:release:2:8:0:0.84',
      '37:release:2:9:0:0.55',
      '38:release:2:10:0:0.55',
      '39:release:2:11:0:0.84',
      '40:release:2:12:1:0.55',
      '41:release:2:13:0:0.55',
    ]);
  });
});
