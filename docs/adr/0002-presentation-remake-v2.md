...
- `VisualQualityProfile` now budgets remake FX (`uiGlowStrength`, `motifDensity`, `particleBurstScale`, `menuAtmosphere`) on the existing low/standard/high tiers. No new player-facing quality axis.
